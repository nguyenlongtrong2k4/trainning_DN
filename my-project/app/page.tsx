    ...
    <div className="container">
        ...
        <div className="main_2">
          <div className="item_main_2">
            ...
            <div className="bottom-right">
              ...
              <Link href="/services" className="btn-box">Click Here</Link>
            </div>
            <div className="decor-lines">
              <span></span><span></span><span></span>
            </div>
            <div className="socials">
              <a href="https://www.facebook.com/longtrongcutedjproducer.99999"><img src="/image/fb.webp" alt="Facebook" /></a>
              <a href="#"><img src="/image/ws.png" alt="WhatsApp" /></a>
              <a href="https://www.youtube.com/@TrongNguyen-cf8kr"><img src="/image/yt.png" alt="YouTube" /></a>
              <a href="https://www.instagram.com/longtrong_0505/"><img src="/image/ig.png" alt="Instagram" /></a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="services">
        ...
        <div className="service-list">
          ...
          <div className="service-card">
            <h2 className="card-title">Branding & Identity</h2>
            <p>
        ...
        <div className="work-list">
          <div className="work-card">
            <div className="work-content">
              <h2 className="card-title">E-commerce Fashion Platform</h2>
          ...
          <div className="work-card">
            <div className="work-content">
              <h2 className="card-title">Creative Agency Portfolio</h2>
              <p>UI/UX Design</p>
              <ul className="card-details">
                <li>
